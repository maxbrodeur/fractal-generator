...
export const fractalgenerator_find_random_chaos_extended: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
export const fractalgenerator_generate_chaos_from_params: (a: number, b: any, c: number, d: number, e: number) => [number, number];
