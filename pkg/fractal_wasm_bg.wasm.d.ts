...
export const fractalgenerator_estimate_bounds_for_map: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
...
export const fractalgenerator_density_grid_to_rgba_log_soft: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
...
export const __wbg_chaoticaccumulator_free: (a: number, b: number) => void;
export const chaoticaccumulator_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => number;
export const chaoticaccumulator_step_batch: (a: number, b: number) => [number, number];
export const chaoticaccumulator_step_batch_with_new: (a: number, b: number) => [number, number];
export const chaoticaccumulator_density: (a: number) => [number, number];
export const chaoticaccumulator_to_rgba_scaled: (a: number, b: number, c: number) => [number, number];
